...
public class DeviceConnFactoryManager {
    ...
    public void openPort() {
        ThreadPool tp = ThreadPool.getInstantiation();
        tp.addTask(new Runnable() {
            @Override
            public void run() {

                deviceConnFactoryManagers[id].isOpenPort = false;
                sendStateBroadcast(mContext, CONN_STATE_CONNECTING);
                ...
                if (isOpenPort) {
                    ...
                    sendStateBroadcast(mContext, CONN_STATE_FAILED);
                }
            }
        });
    }
    ...
    public void closePort(int id) {
        ...
        sendStateBroadcast(mContext, CONN_STATE_DISCONNECT);
    }
    ...
    public static final class Build {
        ...
        public DeviceConnFactoryManager.Build setDevName(String _devName) {
                ...
                case READ_DATA:
                    ...
                    if (sendCommand == esc) {
                        ...
                        if (currentPrinterCommand == null) {
                            ...
                            sendStateBroadcast(mContext, CONN_STATE_CONNECTED);
                        } else {//查询打印机状态
                            if (result == 0) {//打印机状态查询
